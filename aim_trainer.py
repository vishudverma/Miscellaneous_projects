...
LABEL_FONT = pygame.font.SysFont("comicsans", 23)
...
def draw_top_bar(win, elapsed_time: float, targets_pressed: int, misses: int):
    pygame.draw.rect(
        win,
        "grey",
    ...
    win.blit(lives_label, (350, 5))


def end_screen(win, elapsed_time: float, targets_pressed: int, clicks: int):
    win.fill(BG_COLOR)
